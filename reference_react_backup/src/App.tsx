                  ...
                  {activePanel === 'tools' && (
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex flex-col gap-1 pt-2 border-t border-zinc-100 dark:border-zinc-800">
                        ...
                        <button
                          onClick={() => {
                            const newState = activeTool === 'depth' ? null : 'depth';
                            setActiveTool(newState);
                            if (newState === 'depth') setActivePanel(null);
                          }}
                          className={`w-full px-3 py-2 text-left text-[10px] font-bold rounded-md flex items-center justify-between ${
                            activeTool === 'depth' ? 'bg-blue-600 text-white' : 'hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400'
                          }`}
                        >
                          <div className="flex items-center gap-2">
                          ...
                          {activeTool === 'depth' && <div className="w-1.5 h-1.5 rounded-full bg-white animate-pulse" />}
                        </button>
                        <button
                          onClick={() => {
                        ...
                        <button
                          onClick={() => {
                            const newState = activeTool === '3d' ? null : '3d';
                            setActiveTool(newState);
                            if (newState === '3d') setActivePanel(null);
                          }}
                          className={`w-full px-3 py-2 text-left text-[10px] font-bold rounded-md flex items-center justify-between ${
                            activeTool === '3d' ? 'bg-blue-600 text-white' : 'hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400'
                          }`}
                        >
                          <div className="flex items-center gap-2">
